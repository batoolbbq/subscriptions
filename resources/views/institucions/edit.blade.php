            ...
            <div id="docs-card"
                ...
                <div style="padding:22px 20px 26px;">
                    <div class="row g-3">
                        {{-- الرقم التجاري --}}
                        <div class="col-md-6">
                            <label style="display:block;margin-bottom:6px;font-size:.95rem;font-weight:700;">الرقم التجاري</label>
                        ...
                        {{-- ملف الترخيص --}}
                        <div class="col-md-6">
                            <label style="display:block;margin-bottom:6px;font-size:.95rem;font-weight:700;">ملف الترخيص</label>
                        ...
                        {{-- ملف السجل التجاري --}}
                        <div class="col-md-6">
                            <label style="display:block;margin-bottom:6px;font-size:.95rem;font-weight:700;">ملف السجل التجاري</label>
