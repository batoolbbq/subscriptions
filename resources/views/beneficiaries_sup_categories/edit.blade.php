                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label
                                ...
                                اسم الفئة الفرعية <span style="color:#ef4444;">*</span>
                            </label>
                            <input type="text" name="name" class="form-control"
                                ...
                                value="{{ old('name', $item->name) }}" placeholder="اسم الفئة الفرعية" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-control"
                                style="width:100%;border:1px solid #d7dbe0;background:#fdfdfd;border-radius:999px;padding:12px 14px;font-size:1rem;outline:none;"
                                required>
                                <option value="" disabled {{ old('type', $item->type) ? '' : 'selected' }}>اختر النوع
                                </option>
                                <option value="مشترك" {{ old('type', $item->type) == 'مشترك' ? 'selected' : '' }}>مشترك
                                </option>
                                <option value="منتفع" {{ old('type', $item->type) == 'منتفع' ? 'selected' : '' }}>منتفع
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label
                                style="display:block;margin-bottom:6px;color:var(--muted);font-size:.95rem;font-weight:700;">
                                الفئة الرئيسية <span style="color:#ef4444;">*</span>
                            </label>
                            <select name="beneficiaries_categories_id" class="form-control"
                                ...
                                @foreach ($mainCategories as $cat)
                                    <option value="{{ $cat->id }}"
                                        {{ old('beneficiaries_categories_id', $item->beneficiaries_categories_id) == $cat->id ? 'selected' : '' }}>
                                        {{ $cat->name }}
                                    </option>
                                @endforeach
                            </select>
