...
<div class="container py-4" style="font-family: sans-serif;">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <div>
            <h3 style="margin:0;font-weight:800;color:#111827;">إضافة صلاحية جديدة</h3>
            <div style="color:#6b7280;font-size:14px;">أدخل بيانات الصلاحية المطلوبة أدناه.</div>
        </div>
            ...
            <div style="padding:16px;">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="الاسم" class="form-control" style="border:1.5px solid #E5E7EB;" required>
                    </div>
                    <div class="col-md-6">
                        <label style="font-weight:700;color:#374151;">الاسم بالعربي <span style="color:red;">*</span></label>
                        <input type="text" name="name_arabic" value="{{ old('name_arabic') }}" placeholder="الاسم بالعربي" class="form-control" style="border:1.5px solid #E5E7EB;" required>
                    </div>
                </div>
            </div>
        </div>
