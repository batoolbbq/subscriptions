...
<div class="container py-4" style="font-family: sans-serif;">
  ...
  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
    <div>
      <h3 style="margin:0;font-weight:800;color:#111827;">إضافة فئة جديدة</h3>
    ...
    <div style="border:1.5px solid #D0D5DD;border-radius:14px;box-shadow:0 8px 20px rgba(17,24,39,.04);margin-bottom:16px;overflow:hidden;">
      ...
      <div style="padding:16px;">
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <label style="font-weight:700;color:#374151;">الكود (أرقام فقط حتى 5) <span style="color:red;">*</span></label>
