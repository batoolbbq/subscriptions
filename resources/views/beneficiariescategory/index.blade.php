...
@section('content')
    <div class="container py-4"
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 style="color:#92400E;font-weight:700;margin:0;">قائمة الفئات</h3>

            <a href="{{ route('beneficiariescategory.create') }}"
        ...
        <div class="table-responsive"
            ...
            <table style="width:100%;margin:0;color:var(--ink);border-collapse:collapse;">
                ...
                <tbody>
                        ...
                        <tr style="border-top:1px solid var(--line);"
                            ...
                            <td style="padding:14px;">
                                <div style="display:flex;gap:.5rem;flex-wrap:nowrap;align-items:center;">
                                    {{-- زر عرض --}}
                                    <a href="{{ route('beneficiariescategory.show', $i->id) }}"
                                    ...
                                    {{-- زر تعديل --}}
                                    <a href="{{ route('beneficiariescategory.edit', $i->id) }}"
                                        style="display:inline-flex;align-items:center;gap:6px;
                                    ...
                                    {{-- زر حذف --}}
                                    <form action="{{ route('beneficiariescategory.destroy', $i->id) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" style="padding:20px;text-align:center;color:var(--gray-700);">
                                لا توجد بيانات
                            </td>
                        </tr>
                    @endforelse
