...
<div class="container py-4" style="--ink:#111827;--line:#e5e7eb;--blue-50:#f3f6ff;--blue-200:#cfd8ff;--blue-700:#1d4ed8;--amber-50:#fff5e6;--amber-200:#ffd8a8;--amber-800:#92400e;--red-50:#fff1f1;--red-200:#ffc9c9;--red-700:#b42318;--green-50:#e9fbf2;--green-700:#10734a;--gray-50:#eff2f6;--gray-700:#374151;">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3 style="color:var(--ink);font-weight:700;margin:0;">قائمة الفئات </h3>
    <a href="{{ route('beneficiariescategory.create') }}" style="background:var(--blue-50);border:2px solid var(--blue-200);color:var(--blue-700);padding:8px 14px;border-radius:12px;font-weight:800;text-decoration:none;">
      <i class="fa fa-plus"></i> إضافة فئة
    </a>
  </div>
    ...
    <div class="table-responsive">
      <table style="width:100%;margin:0;color:var(--ink);border-collapse:collapse;">
        ...
        <tbody>
            ...
            <tr style="border-top:1px solid var(--line);">
              ...
              <td style="padding:14px;">
                <div style="display:flex;gap:.5rem;flex-wrap:wrap;">
                  <a href="{{ route('beneficiariescategory.show', $i->id) }}" style="background:var(--blue-50);border:2px solid var(--blue-200);color:#0f172a;padding:7px 14px;border-radius:999px;font-weight:800;text-decoration:none;cursor:pointer;">
                    عرض <i class="fa fa-eye"></i>
                  </a>
                  <a href="{{ route('beneficiariescategory.edit', $i->id) }}" style="background:var(--amber-50);border:2px solid var(--amber-200);color:var(--amber-800);padding:7px 14px;border-radius:999px;font-weight:800;text-decoration:none;cursor:pointer;">
                    تعديل <i class="fa fa-edit"></i>
                  </a>
                  <form action="{{ route('beneficiariescategory.destroy', $i->id) }}" method="POST" onsubmit="return confirm('تأكيد الحذف؟');" style="margin:0;">
                    @csrf @method('DELETE')
          ...
          @empty
            <tr>
              <td colspan="5" style="padding:20px;text-align:center;color:var(--gray-700);">لا توجد بيانات</td>
            </tr>
          @endforelse
        </tbody>
      </table>
