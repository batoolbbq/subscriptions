@extends('layouts.app')
@section('title',"تعديل بلدية")

@section('content')
<div class="row small-spacing">
    <div class="col-md-12">
        <div class="box-content ">
            <h4 class="box-title"><a href="{{ route('socialstatuses') }}">البلديات </a>/تعديل بلدية</h4>
        </div>
    </div>
    <div class="col-md-6">
        <div class="box-content">
...
@forelse ($city as $ci)
<option value="{{encrypt($ci->id)}}" {{$Municipal->cities_id == $ci->id  ? 'selected' : ''}}>{{ $ci->name}}</option>
...
@endforelse
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $Municipal->name}}" id="name" placeholder="بلدية" >
                    @error('name')
